...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default = 'iTransformer', type=str, help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, default='XAUm5', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='exness_xau_usd_m5_2020.csv', help='data file')
